<nav class='navbar navbar-expand-lg sticky-top mb-0 border-bottom'>
    <div class="container-fluid justify-content-center">
        <ul class="navbar-nav ">
            <li class="nav-brand"><a class =  "nav-link mx-4" href="./index.php"><img id="logo" src="./src/media/s5_logo.png"></a></li>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                ...
                <li class="nav-item"><a class = "nav-link mx-4" href="./index.php#contact">Contact</a></li>
            </div>
        </ul>
    </div>
    </nav>