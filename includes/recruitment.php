    ...
    <div class="container-sm d-flex align-content-center justify-content-center flex-row mb-5">
        <div id="recruit-tags" class="d-flex">
            <div class="col card-section active " id="pub-sec">
                <div class="rec-card ">
                <img class="recruit-icon" src="./src/media/icons/png/005-government.png" alt="government building icon"></img>
                <h4>Public Sector</h4>
                </div>
            </div>
            <div class="col card-section" id="priv-sec">
                <div class="rec-card">
                    <img class="recruit-icon" src="./src/media/icons/png/004-office.png" alt="business building icon"></img>
                    <h4>Private Sector</h4>
                </div>
            </div>
            <div class="col card-section" id="non-prof">
                <div class="rec-card">
                    <img class = "recruit-icon" src="./src/media/icons/png/006-home.png" alt="non-profit building icon"></img>
                    <h4>Non-Profits</h4>
                </div>
            </div>
        </div>
